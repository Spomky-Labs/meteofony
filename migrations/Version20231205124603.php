 ...
 */
final class Version20231205124603 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'CREATE TABLE security_event (id VARCHAR(255) NOT NULL, owner_id VARCHAR(255) NOT NULL, geoip JSON DEFAULT NULL, type VARCHAR(255) NOT NULL, occurred_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, ip_address VARCHAR(100) DEFAULT NULL, browser VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))'
        );
        ...
        $this->addSql(
            'ALTER TABLE security_event ADD CONSTRAINT FK_D712E90D7E3C61F9 FOREIGN KEY (owner_id) REFERENCES "users" (id) NOT DEFERRABLE INITIALLY IMMEDIATE'
        );
