...
class SecurityEvent
{
    ...
    public function __construct(
        ...
        #[ORM\Column(length: 255)] private readonly string $type,
        #[ORM\ManyToOne(inversedBy: 'securityEvents')] #[ORM\JoinColumn(nullable: false)] private readonly User $owner,
        #[ORM\Column] private readonly DateTimeImmutable $occurredAt,
        #[ORM\Column(length: 100, nullable: true)] private readonly ?string $ipAddress,
        #[ORM\Column(length: 255, nullable: true)] private readonly ?string $browser
    ) {
    }
